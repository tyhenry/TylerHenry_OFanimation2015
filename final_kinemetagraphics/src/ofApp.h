...
public:
    ...
    ImgPose pUserImg; //user image from last frame to detect motion
    bool bDisplayUser;
    ...
    bool bUserMoved, bLoopImgs, bMouseSearch, bDrawLines, bPRefNear, bHideCursor; //booleans for what to draw
    float pRefNear = 3000;
    float pRefFar = 4000;
    
    
    //DEBUG
    bool debug, bDrawSkeleton, bStopSearch;
    int nUsers;
